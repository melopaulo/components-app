...
import {
  ...
  SearchParams,
  ApiResponse,
} from './custom-mat-select3.component';
  ...
  template: `
    <div class="container mx-auto p-6 space-y-8">
      ...
      <mat-expansion-panel class="mt-8">
        ...
        <div class="space-y-6 p-4">
          <div>
            ...
            >
              <li>
                <strong>Busca Local:</strong> Filtra nos itens já carregados em
                tempo real
              </li>
              <li>
                <strong>Busca na API:</strong> Quando você digita 2+ caracteres,
                busca diretamente na API
              </li>
              <li>
                <strong>Debounce:</strong> Aguarda 300ms (configurável) antes de
                fazer a busca na API
              </li>
              <li>
                <strong>Cache Inteligente:</strong> Combina resultados locais e
                da API
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            >
              <li>
                <strong>Carregamento Automático:</strong> Carrega mais itens
                quando você chega a 90% do scroll
              </li>
              <li>
                <strong>Indicador Visual:</strong> Mostra spinner durante o
                carregamento
              </li>
              <li>
                <strong>Paginação Inteligente:</strong> Controla automaticamente
                as páginas
              </li>
              <li>
                <strong>Detecção de Fim:</strong> Informa quando todos os itens
                foram carregados
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            >
              <li>
                <strong>Tamanho da Página:</strong> Configurável (padrão: 20
                itens)
              </li>
              <li>
                <strong>Debounce Time:</strong> Configurável (padrão: 300ms)
              </li>
              <li>
                <strong>Múltipla Seleção:</strong> Suporte a seleção múltipla
              </li>
              <li>
                <strong>Validação:</strong> Integração completa com Angular
                Forms
              </li>
              <li>
                <strong>Mensagens Customizáveis:</strong> Todas as mensagens
          ...
          <div>
            ...
            >
              <li>
                <strong>Grandes Datasets:</strong> Quando você tem milhares de
                opções
              </li>
              <li>
                <strong>APIs Externas:</strong> Busca em tempo real em APIs
              </li>
              <li>
                <strong>UX Avançada:</strong> Quando precisa de uma experiência
                de busca fluida
              </li>
              <li>
                <strong>Performance:</strong> Carregamento sob demanda para
                melhor performance
              </li>
            </ul>
          </div>
      ...
      <div class="flex flex-wrap gap-4 justify-center mt-8">
        ...
        <button mat-outlined-button (click)="logFormValue()" class="min-w-32">
