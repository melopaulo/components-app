...
export class CustomMatSelect4Component implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
  ...
  private loadInitialData() {
    ...
    if (!searchFunction) {
      console.warn('searchFunction não foi fornecida para CustomMatSelect4Component');
      return;
    }
