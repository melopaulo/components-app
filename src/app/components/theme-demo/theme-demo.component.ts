    ...
    <div class="container mx-auto px-4 py-8 animate-fade-in">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-body-large text-surface-600 max-w-2xl mx-auto">
          Demonstração da integração perfeita entre as classes utilitárias do
          Tailwind CSS e os componentes do Angular Material, com suporte
          completo a temas claro e escuro.
        </p>
      </div>
      ...
      <div class="responsive-grid">
        <!-- Card de Cores -->
        <div
          class="material-card elevation-2 hover:elevation-4 transition-all duration-300"
        >
          <h2
            class="text-title-large text-primary-700 mb-6 flex items-center gap-2"
          >
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="flex gap-2 flex-wrap">
                <div
                  class="w-8 h-8 bg-primary-500 rounded-lg shadow-sm"
                  title="Primary 500"
                ></div>
                <div
                  class="w-8 h-8 bg-primary-600 rounded-lg shadow-sm"
                  title="Primary 600"
                ></div>
                <div
                  class="w-8 h-8 bg-primary-700 rounded-lg shadow-sm"
                  title="Primary 700"
                ></div>
                <div
                  class="w-8 h-8 bg-primary-800 rounded-lg shadow-sm"
                  title="Primary 800"
                ></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="flex gap-2 flex-wrap">
                <div
                  class="w-8 h-8 bg-accent-400 rounded-lg shadow-sm"
                  title="Accent 400"
                ></div>
                <div
                  class="w-8 h-8 bg-accent-500 rounded-lg shadow-sm"
                  title="Accent 500"
                ></div>
                <div
                  class="w-8 h-8 bg-accent-600 rounded-lg shadow-sm"
                  title="Accent 600"
                ></div>
                <div
                  class="w-8 h-8 bg-accent-700 rounded-lg shadow-sm"
                  title="Accent 700"
                ></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="flex gap-2 flex-wrap">
                <div
                  class="w-8 h-8 bg-warn-400 rounded-lg shadow-sm"
                  title="Warn 400"
                ></div>
                <div
                  class="w-8 h-8 bg-warn-500 rounded-lg shadow-sm"
                  title="Warn 500"
                ></div>
                <div
                  class="w-8 h-8 bg-warn-600 rounded-lg shadow-sm"
                  title="Warn 600"
                ></div>
                <div
                  class="w-8 h-8 bg-warn-700 rounded-lg shadow-sm"
                  title="Warn 700"
                ></div>
              </div>
            </div>
        ...
        >
          ...
          <div class="space-y-4">
            ...
            <div class="text-headline-large text-surface-800">
              Headline Large
            </div>
            <div class="text-title-large text-surface-700">Title Large</div>
            <div class="text-body-large text-surface-600">
              Body Large - Texto padrão para conteúdo
            </div>
            <div class="text-label-large text-surface-500">
              Label Large - Para rótulos
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div class="space-y-4">
            ...
            <div class="flex gap-3 flex-wrap">
              ...
              <button mat-button color="primary">Texto</button>
        ...
        <!-- Card de Formulário -->
        <div
          class="material-card elevation-2 hover:elevation-4 transition-all duration-300 col-span-full lg:col-span-2"
        >
          <h2
            class="text-title-large text-primary-700 mb-6 flex items-center gap-2"
          >
        ...
        >
          ...
          <div class="space-y-4">
            ...
            <div
              class="p-4 bg-accent-50 rounded-lg border-l-4 border-accent-500"
            >
      ...
      <div class="text-center">
        ...
        <div class="flex-center gap-4 text-body-large">
          ...
          <span class="text-surface-500">
            (Efetivo:
            {{ themeService.effectiveTheme() === 'dark' ? 'Escuro' : 'Claro' }})
          </span>
        </div>
      </div>
    </div>
