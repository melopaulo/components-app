...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './components/custom-mat-select/custom-mat-select-demo.component'
      ).then((m) => m.CustomMatSelectDemoComponent),
  },
  {
    path: 'custom-mat-select3',
    loadComponent: () =>
      import(
        './components/custom-mat-select3/custom-mat-select3-demo.component'
      ).then((m) => m.CustomMatSelect3DemoComponent),
  },
  // {
  ...
  // },
  {
    ...
    loadComponent: () =>
      import(
        './components/custom-mat-select5/custom-mat-select5-demo.component'
      ).then((m) => m.CustomMatSelect5DemoComponent),
  },
  {
    path: 'reusable-table',
    loadComponent: () =>
